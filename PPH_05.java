...
public class PPH_05 {
	...
	private void run(String inputFile) {
		try {
			...
			List<OrderedPair> listOriginalPair = Utils.getValuesFromInputFile(
					scanner, quantityOfInputValues);
	...
	private float maximumRation(List<OrderedPair> listOrderedPairs,
			List<OrderedPair> listS, OrderedPair inicialPar) {
		float aux = 0;
