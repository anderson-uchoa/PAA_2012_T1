...
public class PPH_08_SelectionSort_N2 {
  ...
  public static void main(String[] args) {
    ...
    PPH_08_SelectionSort_N2 pph = new PPH_08_SelectionSort_N2();
    pph.run(inputFile);
  }
  ...
  public void run(String inputFile) {
    try {
      Log.printOntoScreen("Iniciado SelectionSort - O(n2)...");
      ...
      while (System.currentTimeMillis() - startTime < 5000) {
        ...
        // Ordenando a lista
        questao01.pph.ordenacao.SelectionSort sorter = new questao01.pph.ordenacao.SelectionSort();
