...
public class Mergesort {
	...
	private <T extends Comparable<T>> void mergesort(int low, int high,
			List<T> list, List<T> helper) {
	...
	private <T extends Comparable<T>> void merge(int low, int middle, int high,
			List<T> list, List<T> helper) {
